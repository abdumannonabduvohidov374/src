...
const Dashboard = () => {
  ...
  const dash = {
        dashbord: '<i className="icons fa-solid fa-gauge-high"></i> Dashboard',
        components: '<i className="icons fa-brands fa-creative-commons-remix"></i> Components',
        statistics: '<i className="icons fa-regular fa-address-card"></i> Statistics',
        data: '<i className="icons fa-regular fa-rectangle-list"></i> Data',
        chart: '<i className="icons fa-solid fa-chart-line"></i> Chart',
        chat: '<i className="icons fa-regular fa-comment-dots"></i> Chat',
        calendar: '<i className="icons fa-regular fa-calendar"></i> Calendar',
        kanban: '<i className="icons fa-solid fa-layer-group"></i> Kanban',
        customer: '<i className="icons fa-solid fa-headphones"></i> Customer',
        invoice: '<i className="icons fa-regular fa-file-lines"></i> Invoice',
        profile: '<i className="fa-regular fa-user"></i> Profile',
        ecommerce: '<i className="icons fa-solid fa-cart-shopping"></i> E-commerce',
        formsvalid: '<i className="icons fa-brands fa-wpforms"></i> Forms Validation',
        formswizard: '<i className="iconsfa-solid fa-forward-step"></i> Forms Wizard',
        layout: '<i className="icons fa-regular fa-pen-to-square"></i> Layout',
        plugins: '<i className="icons fa-solid fa-cloud-arrow-up"></i> Plugins',
        reactable: '<i className="icons fa-solid fa-table"></i> React Table',
        muitable: '<i className="icons fa-solid fa-table-cells"></i> MUI Table',
        charts: '<i className="icons fa-solid fa-chart-pie"></i> Charts',
  ...
  const [collapce, setCollapce] = useState(false);
  ...
  return (
    <>
      <div className="dashmenu">
        <div className={menu == true ? "dashboard active" : "dashboard"}>
          <a href="#" className="svg">
            ...
            >
              ...
              <path
                ...
                fill="#177ddc"
              ></path>
              <path className={menu == true ? "name active" : "name"}
              ...
              <defs>
                ...
                >
                  <stop stop-color="#8dcff8"></stop>
                  <stop offset="1" stop-color="#3c9ae8" stop-opacity="0"></stop>
                </linearGradient>
              </defs>
            </svg>
          </a>
          <div className="dash-menu">
            <p className={menu == true ? "dash name active" : "dash name"}>Dashboard</p>
            <p className="dash-btn btns" onClick={Collapce}>
              <div className="flex">

              <i className="fa-solid fa-gauge-high"></i>
              <p className={menu == true ? "lefti name active" : "lefti name"} >Dashborad</p>
              </div>
              <i className={menu == true ? "fa-solid fa-chevron-down left name active" : "fa-solid fa-chevron-down left name" }
                  id={collapce == true ? 'rotate180' : 'rotate0'}  ></i>
            </p>
            <div className={collapce == true ? 'collapce active' : 'collapce'}><p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut dolorum iste eveniet quos vitae est tempore assumenda rem molestiae repellat, reprehenderit molestias impedit eaque laudantium, error suscipit dolorem sit? Voluptate!</p> </div>
            <p className="components-btn btns">
              <div className="flex">

              <i className="fa-regular fa-window-restore"></i>
              <p className={menu == true ? "lefti name active" : "lefti name"}>Components</p>
              </div>
              <i className={menu == true ? "fa-solid fa-chevron-down left name active" : "fa-solid fa-chevron-down left name"}></i>
            </p>
          </div>
          <div className="widgets-menu">
            <p className={menu == true ? "dash name active" : "dash name"}>Widgets</p>
            <p className="widget-btn btns">
              <div className="flex">

              <i className="fa-regular fa-address-card"></i>
              <p className={menu == true ? "lefti name active" : "lefti name"}>Statistics</p>
              </div>
            </p>
            <p className="widget-btn btns">
              <div className="flex">
              ...
              <p className={menu == true ? "lefti name active" : "lefti name"}>Data</p>
              </div>
            </p>
            <p className="widget-btn btns">
              <div className="flex">
              ...
              <p className={menu == true ? "lefti name active" : "lefti name"}>Chart</p>
              </div>
            </p>
          </div>
        </div>
